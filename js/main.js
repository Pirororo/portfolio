...
$(function () {
    ...
    var logoClosing = $('.logo');
    setTimeout(function () {
        // logoClosing.addClass('inactive');
    }, 3000);

    var logoRotating = $('.wrap-logo');
    setTimeout(function () {
        logoRotating.addClass('rotate');
    }, 3000);

    var fraiseStarting = $('.fraise-main');
    setTimeout(function () {
        fraiseStarting.addClass('active');
    }, 3000);
